...
if (!supabaseUrl) {
  throw new Error('SUPABASE_URL environment variable is required. Set SUPABASE_URL or VITE_SUPABASE_URL.');
}
if (!supabaseServiceKey) {
  throw new Error('SUPABASE_SERVICE_KEY environment variable is required. Never hardcode service keys.');
}
