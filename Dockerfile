...
# ADSENSE: "true" turns on AdSense + the Google consent CMP. Anything else (or
# unset, which is what an undeclared ARG yields) leaves them off.
...
ENV VITE_FIREBASE_API_KEY=$VITE_FIREBASE_API_KEY \
    ...
    VITE_SUPABASE_ANON_KEY=$VITE_SUPABASE_ANON_KEY     VITE_ADS_ENABLED=$VITE_ADS_ENABLED
