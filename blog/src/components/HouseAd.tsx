// The self-promo creative that used to be the only thing Ad1/Ad2 ever rendered.
// It is now the fallback shown whenever AdSense cannot serve — no slot id
// configured, unfilled inventory, script blocked, or ads switched off entirely.
export const HouseAd = ({ className = "" }: { className?: string }) => (
  <a
