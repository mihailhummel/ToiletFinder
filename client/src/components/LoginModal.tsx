      ...
      >
        ...
        <div className="text-center space-y-6">
          ...
          <Button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center space-x-3 bg-white hover:bg-gray-50 text-gray-900 border-2 border-gray-300 shadow-sm h-12 font-medium disabled:opacity-60 disabled:cursor-not-allowed"
            variant="outline"
          >
            {!isLoading && (
            ...
            <span>{isLoading ? 'Signing in…' : `${t('login.signInWith')} ${t('login.google')}`}</span>
          </Button>
