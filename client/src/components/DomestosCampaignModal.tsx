            ...
            {aboutOpen && (
              <div className="px-3.5 pb-3.5">
                ...
                <div className="space-y-2 text-[11.5px] leading-relaxed text-slate-700">
                  ...
                  <p>От 01.07 до 30.08.2026 г. потребителите ще могат активно да оценяват и добавят различни софийски локации в платформата, а 10-те най-високо оценени тоалетни ще получат специално отличие от Domestos и продуктова подкрепа за поддържане на хигиената до края на годината.</p>
